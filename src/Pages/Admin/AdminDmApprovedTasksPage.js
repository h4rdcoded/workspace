...
const AdminDmApprovedTasksPage = () => {
  ...
  // Fetch DM approved tasks 
  const fetchDmApprovedTasks = async (page = 1) => {
    try {
      setLoading(true);
      
      // Get tasks with status 'DM_APPROVED' 
      const response = await axios.get(
        buildApiUrl(`/tasks/admin/dm-approved?page=${page}&limit=${tasksPerPage}`),
      ...
      console.error('Error fetching DM approved tasks:', error);
      if (error.response) {
  ...
  useEffect(() => {
    fetchDmApprovedTasks(currentPage);
  }, [currentPage]);
          ...
          <div className="container-fluid">
            <div className="d-flex justify-content-center align-items-center" style={{ height: '100vh' }}>
              <div className="text-center">
                ...
                <p className="mt-2 text-muted">Loading department manager approved tasks...</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="row mb-4">
                <div className="col-12">
                  <div className="d-flex justify-content-between align-items-center">
                    <div>
                      <h4 className="mb-0">Department Manager Approved Tasks</h4>
                      <p className="text-muted mb-0">Tasks approved by department managers</p>
                    </div>
                ...
                <div className="col-12">
                  <div className="card border-0 shadow-sm">
                    <div className="card-header bg-white border-0">
                      <div className="d-flex justify-content-between align-items-center">
                        <h5 className="mb-0">Tasks Approved by Department Managers</h5>
                    ...
                    <div className="card-body">
                      {tasks.length > 0 ? (
                            ...
                            <tbody>
                              {tasks.map((task, index) => (
                                <tr key={task.id}>
                                  ...
                                  <td>
                                    <span>{task.department_name || 'Unknown'}</span>
                                  </td>
                                  <td>
                                  ...
                                  {/* <td>
                                    <span className={`badge ${
                                      ...
                                      task.task_type === 'SUBTASK' ? 'bg-info' : 'bg-secondary'
                                    }`}>
                                      {task.task_type === 'MAIN_TASK' ? 'Main Task' : 
                                       task.task_type === 'SUBTASK' ? 'Subtask' : 'Daily Routine'}
                                    </span>
                                  </td> */}
                                  <td>
                                    <div className="d-flex gap-2">
                        ...
                        <div className="text-center py-5">
                          ...
                          <h5 className="mt-3">No department manager approved tasks</h5>
                          <p className="text-muted">There are no tasks approved by department managers yet.</p>
                        </div>
                      )}
                      {/* Pagination */}
...
export default AdminDmApprovedTasksPage;