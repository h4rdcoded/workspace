...
const EmployeesWithoutTasks = () => {
  const { leadCrmApiURL, leadCrmHeaders, staticFilesBaseURL } = useContext(ConfigContext);
      ...
      <div className="main-content">
        <div className="page-content">
          <div className="container-fluid">
            <PageTitle title="Employees Without Tasks" primary="Task Management" />
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <p className="text-muted mb-0">
                    Showing {employeesData.total_count} employees across {departments.length} departments
                  </p>
                </div>
                  ...
                  <div className="card-body text-center py-5">
                    ...
                    <p className="text-muted">
                      {searchTerm 
                        ...
                        : 'All employees have at least one assigned task.'}
                    </p>
                    {!searchTerm && (
                      <button 
...
export default EmployeesWithoutTasks;